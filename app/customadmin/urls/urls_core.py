...
urlpatterns += [
    ...
    # ------------------------------------------------------------------------------------------------------
    # Service categories
    path("service-categories/<int:pk>/detail/", views.ServiceCategoryDetailView.as_view(),
         name="servicecategory-detailview"),
    ...
    path("service-categories/<int:pk>/update/", views.ServicecategoryUpdateView.as_view(),
         name="servicecategory-update"),
    path("service-categories/<int:pk>/delete/", views.ServiceCategoryDeleteView.as_view(),
    ...
    path("purchased-product/<int:pk>/update/", views.PurchasedProductUpdateView.as_view(),
         name="purchasedproduct-update"),
    path("purchased-product/<int:pk>/delete/", views.PurchasedProductDeleteView.as_view(),
         name="purchasedproduct-delete"),
    ...
    # ------------------------------------------------------------------------------------------------------
    path('books/<int:pk>/detail', views.BookDetailView.as_view(), name="book-detailview"),
    path('books/',views.BookListView.as_view(), name = "book-list"),
    path('books/create',views.BookCreateView.as_view(), name='book-create'),
    path('books/<int:pk>/update/',views.BookUpdateView.as_view(),name='book-update'),
    path('books/<int:pk>/delete/', views.BookDeleteView.as_view(), name = 'book-delete'),
    path("ajax-books", views.BookAjaxPagination.as_view(), name="book-list-ajax"),
