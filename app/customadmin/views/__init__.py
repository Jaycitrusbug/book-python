...
from .inquiry import InquiryAjaxPagination, InquiryCreateView, InquiryDeleteView, InquiryDetailView, InquiryListView, \
    InquiryUpdateView
from .phone_code import PhoneNumberCodeAjaxPagination, PhoneNumberCodeCreateView, PhoneNumberCodeDeleteView, \
    PhoneNumberCodeUpdateView, PhoneNumberCodeListView
